module.exports = function (app, db, jwt, dlOptions) {
    ...
    var storage = multer.diskStorage({
        ...
        filename: function (req, file, cb) {
            ...
            file.hashedPath = uuidv4() + "." + file.originalname.split(".")[1]
            cb(null, file.hashedPath);
        }
    });
    ...
    app.delete("/binaries", async function (req, res, next) {
        try {
            const path = req.query.path;
            // const mail = await jwt.verify(req.body.accessToken, "e1231");

            db.collection("binaries").remove({
                "hashedPath": path,
            });
